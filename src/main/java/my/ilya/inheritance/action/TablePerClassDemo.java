...
public class TablePerClassDemo {
    ...
    private static void demo() {
        OrderItemPer orderItem = new OrderItemPer();
        orderItem.setName("Main order");

        TransferOrderItemPer transferOrderItem = new TransferOrderItemPer();
        transferOrderItem.setName("Transfer Order Item");
        transferOrderItem.setDate(new Date());

        ExpulsionOrderItemPer expulsionOrderItem = new ExpulsionOrderItemPer();
